...
from src.core.telemetry import TelemetryCollector, get_telemetry as _get_telemetry
from src.database.connection import DatabaseManager, get_db as _get_db
