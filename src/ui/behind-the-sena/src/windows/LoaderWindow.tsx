...
export function LoaderWindow() {
  ...
  return (
    <div className="relative w-full h-full rounded-[28px] border border-white/10 bg-gradient-to-br from-[#08163b] via-[#050e24] to-[#020712] p-6 shadow-[0_25px_70px_rgba(2,6,19,0.75)] overflow-hidden">
