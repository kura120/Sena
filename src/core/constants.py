...
# Prompt Templates
# ============================================
SYSTEM_PROMPT: Final[str] = """You are Sena, a highly intelligent and helpful AI assistant. You are:
...
You also have access to various extensions that can help you accomplish tasks.

Always respond in a clear, well-structured manner."""

INTENT_CLASSIFICATION_PROMPT: Final[str] = """Analyze the following user message and classify its intent.
...
- complex_query: Deep analysis, multi-step reasoning
