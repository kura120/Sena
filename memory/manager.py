...
class MemoryManager:
    ...
    def __init__(
        ...
        self.short_term = ShortTermMemory(max_messages=20, ttl_hours=1)
    ...
    async def add_to_context(
        ...
        """
        try:
            return await self.short_term.add(
                content=content,
                role=role,
                metadata=metadata
            )
    ...
    async def should_use_memory(
        ...
        """
        try:
            return await self.retrieval_engine.should_retrieve(
    ...
    async def get_relevant_memories(
        ...
        """
        try:
            return await self.retrieval_engine.retrieve_relevant(
                user_input=user_input,
                k=k
            )
        except Exception as e:
    ...
    async def extract_and_store_learnings(
        ...
        try:
            ...
            # Store learnings
            results = await self.retrieval_engine.store_learnings(
                learnings=learnings,
